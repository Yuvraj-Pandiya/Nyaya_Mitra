...
const techStack = ['Next.js 14 (App Router)', 'TypeScript', 'Tailwind CSS', 'i18next (Hindi + English)', 'jsPDF (document generation)', 'Java + Spring Boot (backend)', 'MongoDB Atlas', 'Google Gemini Flash (AI)'];
